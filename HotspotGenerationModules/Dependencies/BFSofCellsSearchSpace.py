...
from AddCoordinatesToHotspots import GridCellsToPolygonesSearchSpace
        ...
        for __x in range(self.__x_axis_size - 1):
            for __y in range(self.__y_axis_size - 1):
                ...
                if (self.__grid[__x][__y] and not self.__visited_points[__x][__y]):
                    ...
                    Hotspot_Polygon = GridCellsToPolygonesSearchSpace(__island_of_points, self.xx, self.yy)
