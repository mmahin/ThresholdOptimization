...
variable2_name = 'PctEmpAgriculture'
...
Y_label = 'Agriculture Employment Rate(t\')'
Z_Label = '$I_{(Covid-19\ Infection\ Rate, t),(Agriculture\ Employment\ Rate, t\'))}$'

Output_path1 = 'C:/Users/mdmah/PycharmProjects/ProfessorEick/ProfessorEick/ThresholdOptimization/Outputs/Agreements/TwoThresholdsTwolimit/HighLow/agreementTwoAreaRestrictedWithTwoThresholdHighLowCovidEmplAgriculture.txt'
Output_path2 = 'C:/Users/mdmah/PycharmProjects/ProfessorEick/ProfessorEick/ThresholdOptimization/Outputs/Agreements/TwoThresholdsTwolimit/LowHigh/agreementTwoAreaRestrictedWithTwoThresholdLowHighCovidEmplAgriculture.txt'
Output_path3 = 'C:/Users/mdmah/PycharmProjects/ProfessorEick/ProfessorEick/ThresholdOptimization/Outputs/Agreements/TwoThresholdsTwolimit/LowLow/agreementTwoAreaRestrictedWithTwoThresholdLowLowCovidEmplAgriculture.txt'
...
for i in range(len(threshold1_values)):
    threshold1_values[i] = (1/threshold1_values[i])-1
# Visualize the agreement search space
VisualizeTwoVariableInterestingnessSearchSpace(threshold1_values, threshold2_values, agreements, X_label, Y_label, Z_Label)# calculate total observation area
