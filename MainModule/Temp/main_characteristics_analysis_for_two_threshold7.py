...
steps = 100
hotspot_area_restriction1 = 1
hotspot_area_restriction2 = 0
...
X_label = 'Unemployment Rate (t)'
Y_label = 'Poverty Rate(t\')'
Z_Label = '$I_{(Unemployment\ Rate , t),(Povert\ Rate ,t\'))}$'

Output_path = 'C:/Users/mdmah/PycharmProjects/ProfessorEick/ProfessorEick/ThresholdOptimization/Outputs/Agreements/TwoThresholdsTwolimit/agreementTwoAreaRestrictedWithTwoThresholdUmemploymentPovert-100-0.txt'
