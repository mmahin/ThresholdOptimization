...
max_variable2 = 60#max(variable2_df['values'])#60#100000#
...
for i in range(100):
    for j in range(100):
        if i >=78 and i<=99 and j >=84 and j<=99:
            v1.append(variable1_value_matrix[i][j])
            v2.append(variable2_value_matrix[i][j])
print(max(v1),max(v2))
'''
